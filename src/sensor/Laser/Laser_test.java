...
public class Laser_test{
	public static void main(String[] args){
		LaserSensorInterface2 lsi = new LaserSensorInterface2("/dev/ttyO4");
		while(true){
			lsi.getRanging();
...
class LaserSensorInterface2{
	String serialPortName;
	InputStream in;
	OutputStream out;
	public LaserSensorInterface2(String serialPortName){
